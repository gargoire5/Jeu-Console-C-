...
namespace Jeu_Console_C_
{
    internal class Team
    {
        ...
        public void AddPokemon(Techmons techmon)
        {
            ...
            string jsonAddtechmons = JsonConvert.SerializeObject(techmon);
            File.WriteAllText("AddPokemons.json", jsonAddtechmons );
            Console.WriteLine("Données des Techmons sauvegardées dans un fichier JSON.");
        }
